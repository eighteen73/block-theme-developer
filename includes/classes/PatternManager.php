...
class PatternManager {
	...
	public function __construct() {
		add_action( 'init', [ $this, 'sync_role_capabilities' ], 5 );
	...
	public static function on_activation(): void {
		self::sync_capabilities_for_roles();

		flush_rewrite_rules();
	}

	/**
	 * Ensure required btd pattern capabilities are present for supported roles.
	 *
	 * @return void
	 */
	...
	/**
	 * Add all capabilities generated by map_meta_cap for the custom post type.
	 *
	 * @return void
	 */
	private static function sync_capabilities_for_roles(): void {
		$roles = [ 'administrator' ];
		$caps  = [
			'edit_btd_pattern',
			'read_btd_pattern',
			'delete_btd_pattern',
			'edit_btd_patterns',
			'edit_others_btd_patterns',
			'publish_btd_patterns',
			'read_private_btd_patterns',
			'delete_btd_patterns',
			'delete_private_btd_patterns',
			'delete_published_btd_patterns',
			'delete_others_btd_patterns',
			'edit_private_btd_patterns',
			'edit_published_btd_patterns',
			'create_btd_patterns',
		];
